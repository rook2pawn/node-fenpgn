...
var t = require('tape');
t('testBoardToFenPos',function(test) {
  var startboard = h.start();
  var newboard = h.updateBoardMSAN(startboard,'g1f3');
  ...
  test.equals(game.toFenPos(newboard.board),game.toFenPos(lasthistory.board));
